...
// Map module names to routes for the Sales dashboard (dashboard_id: 102)
const MODULE_ROUTES: Record<string, string> = {
  "Sales Overview": "/sales/overview",
  "Revenue Reports": "/sales/revenue-reports",
  "Team Performance": "/sales/team-performance",
  "Stock Overview": "/sales/stock-overview",
}
