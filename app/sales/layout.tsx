...
import { ChevronLeft, BarChart3, DollarSign, Users2, Package } from "lucide-react"
...
// Map module names to routes and icons for the Sales dashboard (dashboard_id: 102)
const MODULE_CONFIG: Record<string, { route: string; icon: typeof BarChart3 }> = {
  "Sales Overview": { route: "/sales/overview", icon: BarChart3 },
  "Revenue Reports": { route: "/sales/revenue-reports", icon: DollarSign },
  "Team Performance": { route: "/sales/team-performance", icon: Users2 },
  "Stock Overview": { route: "/sales/stock-overview", icon: Package },
}
